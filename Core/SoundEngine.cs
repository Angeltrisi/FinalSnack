...
namespace FinalSnack.Core
{
    ...
    public static class SoundEngine
    {
        ...
        public static Channel PlaySound(string path, PlaySoundParameters parameters = default, bool register = false)
        {
            Sound inst;
            ...
            {
                inst = CoreSystem.LoadSound(path);
                if (register)
        ...
        /// <returns></returns>
        public static Sound LoadSound(string path, bool streamed = false)
        {
